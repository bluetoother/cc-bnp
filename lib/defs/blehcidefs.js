 ...
 * 
 *************************************************************************/
BHCI.cmdValBuild = ['AttWriteReq', 'GattWriteCharValue'];

BHCI.cmdWithUuid = ['AttReadByTypeReq', 'AttReadReq', 'AttReadMultiReq', 'AttWriteReq', 'GattReadCharValue', 'GattReadUsingCharUuid', 'GattReadMultiCharValues', 'GattWriteCharValue'];
