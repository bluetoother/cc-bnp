 ...
 * 
 *************************************************************************/
BHCI.cmdValBuild = ['AttReadMultiReq', 'AttWriteReq', 'AttHandleValueNoti', 'AttHandleValueInd', 'AttFindByTypeValueReq',
					'GattDiscPrimaryServiceByUuid', 'GattReadMultiCharValues', 'GattWriteCharValue', 'GattWriteNoRsp', 
					'GattSignedWriteNoRsp', 'GattWriteCharDesc', 'GattNotification', 'GattIndication', 'AttReadByTypeRsp', 
					'AttReadRsp', 'AttReadMultiRsp'];


BHCI.cmdWithUuid = ['AttReadByTypeReq', 'AttReadReq', 'AttReadMultiReq', 'AttWriteReq', 'AttHandleValueNoti',
					'AttHandleValueInd', 'GattDiscPrimaryServiceByUuid','GattReadCharValue', 'GattReadUsingCharUuid', 
					'GattReadMultiCharValues', 'GattWriteCharValue', 'GattWriteNoRsp', 'GattSignedWriteNoRsp', 
					'GattWriteCharDesc', 'GattNotification', 'GattIndication', 'AttReadByTypeRsp', 'AttReadRsp', 
					'AttReadMultiRsp'];
