...
BHCI.timeout.level1 = [
    ...
    'AttWriteReq', 'AttExecuteWriteReq', 'AttHandleValueInd', 'GattExchangeMtu', 'GattReadCharValue', 'GattReadLongCharValue', 
    'GattWriteCharValue', 'GattWriteLongCharValue', 'GattReadCharDesc', 'GattReadLongCharDesc', 'GattWriteCharDesc', 
    'GattWriteLongCharDesc', 'GattIndication'
];

BHCI.timeout.level2 = [
    'GapDeviceDiscReq', 'GapAuthenticate', 'AttFindInfoReq', 'AttFindByTypeValueReq', 'AttReadByTypeReq', 'AttReadMultiReq', 
    'AttReadByGrpTypeReq',  'GattDiscAllPrimaryServices', 'GattDiscPrimaryServiceByUuid', 'GattFindIncludedServices', 
    'GattDiscAllChars', 'GattDiscCharsByUuid', 'GattDiscAllCharDescs', 'GattReadUsingCharUuid', 'GattReadMultiCharValues', 
    'GattReliableWrites'
];
