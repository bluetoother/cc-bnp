 ...
 * 
 *************************************************************************/
BHCI.cmdValBuild = ['AttWriteReq', 'AttHandleValueNoti', 'AttHandleValueInd', 'GattWriteCharValue', 
					'GattWriteNoRsp', 'GattSignedWriteNoRsp', 'GattWriteCharDesc', 'GattNotification',
					'GattIndication', 'AttReadByTypeRsp', 'AttReadRsp', 'AttReadMultiRsp'];


BHCI.cmdWithUuid = ['AttReadByTypeReq', 'AttReadReq', 'AttReadMultiReq', 'AttWriteReq', 'AttHandleValueNoti',
					'AttHandleValueInd', 'GattReadCharValue', 'GattReadUsingCharUuid', 'GattReadMultiCharValues', 
