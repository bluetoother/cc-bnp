...
var hciCharMeta = {
    ...
    '0x2a18' : {
        ...
        types : ['bit8', 'uint16', 'uint16', 'uint8', 'uint8', 'uint8', 'uint8', 'uint8'],
        extra: {
            params : ['TimeOffset', 'GlucoseKg', 'GlucoseMol','Type', 'SampleLocation', 'SensorStatus'],
            types : ['int16', 'sfloat', 'sfloat', 'nibble', 'nibble', 'bit16'],
    ...
    '0x2a1c' : {
        ...
        extra: {
            ...
            types : ['float', 'float', 'uint16', 'uint8', 'uint8', 'uint8', 'uint8', 'uint8', 'bit8'],
    ...
    '0x2a2b' : {
        ...
        types : ['uint16', 'uint8', 'uint8', 'uint8', 'uint8', 'uint8', 'uint8', 'uint8', 'bit8']
    },
    '0x2a2c' : {
    ...
    '0x2a34' : {
        ...
        extra: {
            ...
            types : ['bit8', 'uint8', 'sfloat', 'uint8', 'nibble', 'nibble', 'uint16', 'uint8', 'uint8', 'sfloat', 'sfloat', 'sfloat'],
    ...
    '0x2a35' : {
        ...
        extra: {
            ...
            types : ['sfloat', 'sfloat', 'sfloat', 'sfloat', 'sfloat', 'sfloat', 'uint16', 'uint8', 'uint8', 'uint8', 'uint8', 'uint8', 'sfloat', 'uint8', 'bit16'],
    ...
    '0x2a9c' : {
        ...
        extra: {
            ...
            flags: [0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0004, 0x0008, 0x0010, 0x0021, 0x0021, 0x0041, 0x0041, 0x0081, 0x0081, 0x0101, 0x0101, 0x0200, 0x0401, 0x0401, 0x0801],
            result: [0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0004, 0x0008, 0x0010, 0x0020, 0x0021, 0x0040, 0x0041, 0x0080, 0x0081, 0x0100, 0x0101, 0x0200, 0x0400, 0x0401, 0x0801]
        }
    },
    '0x2a9d' : {
        params : ['Flags'],
    ...
    '0x2aa8' : {
        ...
        types : ['bit24', 'nibble', 'nibble', 'uint16']
    },
    //TODO E2E-CRC
    // '0x2aa9' : {
