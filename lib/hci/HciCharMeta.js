...
var hciCharMeta = {
    ...
    '0x290c' : {
        params : ['Flags', 'SamplFunc', 'MeasurementPeriod', 'UpdateInterval', 'Application', 'MeasurementUncertainty'],
    ...
    '0x2a5e' : {
        params : ['Flags', 'SpO2', 'PR'],
        types : ['uint8', 'sfloat', 'sfloat'],
        extra: {
            params : ['Year', 'Month', 'Day', 'Hours', 'Minutes', 'Seconds', 'MeasurementStatus', 'DeviceAndSensorStatus', 'PulseAmplitudeIndex'],
    ...
    '0x2a5f' : {
        ...
        types : ['uint8', 'sfloat', 'sfloat'],
        extra: {
            params : ['FastSpO2', 'FastPR', 'SlowSpO2', 'SlowPR', 'MeasurementStatus', 'DeviceAndSensorStatus', 'PulseAmplitudeIndex'],
    ...
    //     types : ['uint8'],
    //     extra: {
    //         params : ['CumulativeCrankRevolutions', 'LastCrankEventTime', 'FirstCrankMeasurementAngle', 'InstantaneousForceMagnitudeArray', 'Instantaneous Torque Magnitude Array'],
    //         types : ['uint16', 'uint16'],
    //         flags: [0x01, 0x01],
    //         result: [0x01, 0x01]
    //     }
    ...
    '0x2a67' : {
        ...
        types : ['uint8'],
        extra: {
            params : ['InstantaneousSpeed', 'TotalDistance', 'Latitude', 'Longitude', 'Elevation', 'Heading', 'RollingTime', 'Year', 'Month', 'Day', 'Hours', 'Minutes', 'Seconds'],
    ...
    '0x2a68' : {
        ...
        extra: {
            params : ['RemainingDistance', 'RemainingVerticalDistance', 'Year', 'Month', 'Day', 'Hours', 'Minutes', 'Seconds'],
    ...
    '0x2a69' : {
        ...
        types : ['uint8'],
        extra: {
            params : ['NumberOfBeaconsInSolution', 'NumberOfBeaconsInView', 'TimeToFirstFix', 'EHPE', 'EVPE', 'HDOP', 'VDOP'],
    ...
    '0x2a8b' : {
        params : ['VeryLight/Light', 'Light/Moderate', 'Moderate/Hard', 'Hard/Max'],
        types : ['uint8', 'uint8', 'uint8', 'uint8']
    },
    '0x2a8c' : {
        params : ['Gender'],
    ...
    '0x2a94' : {
        params : ['Light/Moderate', 'Moderate/Hard'],
        types : ['uint8', 'uint8']
    },
    '0x2a95' : {
        params : ['Fatburn/FitnessLimit'],
        types : ['uint8']
    },
    '0x2a96' : {
        params : ['VO2Max'],
    ...
    '0x2aa6' : {
        params : ['CentralAddrResolutionSupport'],
        types : ['uint8']
    },
    //TODO variable
    // '0x2aa7' : {
