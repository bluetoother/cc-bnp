...
var hciCharMeta = {
 ...
 /*   '0xcc00' : {
        params: ['flags', 'dInState', 'counter', 'dInPolarity', 'debouncePeriod', 'edgeSelection', 'counterReset', 'appType', 'sensorType'],
        types: ['uint8', 'bool', 'uint8', 'bool', 'uint16', 'uint8', 'bufferPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
    },
    '0xcc01' : {
        params: ['flags', 'dOutState', 'dOutPolarity', 'appType'],
        types: ['uint8', 'bool', 'bool', 'stringPreLenUint8']
    },
    '0xcc02' : {
        params: ['flags', 'aInCurrValue', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues', 'appType', 'sensorType'],
        types: ['uint8', 'float', 'float', 'float', 'float', 'float', 'bufferPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
    },
    '0xcc03' : {
        params: ['flags', 'aOutCurrValue', 'minRangeValue', 'maxRangeValue', 'appType'],
        types: ['uint8', 'float', 'float', 'float', 'stringPreLenUint8']
    },
    '0xcc04' : {
        params: ['flags', 'sensorValue', 'units', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues', 'appType', 'sensorType'],
        types: ['uint8', 'float', 'stringPreLenUint8', 'float', 'float', 'float', 'float', 'bufferPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
    },
    '0xcc05' : {
        params: ['flags', 'sensorValue', 'units', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues'],
        types: ['uint8', 'float', 'stringPreLenUint8', 'float', 'float', 'float', 'float', 'bufferPreLenUint8']
    },
    '0xcc06' : {
        params: ['flags', 'dInState', 'counter', 'counterReset', 'sensorType', 'busyToClearDelay', 'clearToBusyDelay'],
        types: ['uint8', 'bool', 'uint8', 'bufferPreLenUint8', 'stringPreLenUint8', 'uint16', 'uint16']
    },
    '0xcc07' : {
        params: ['flags', 'sensorValue', 'units', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues'],
        types: ['uint8', 'float', 'stringPreLenUint8', 'float', 'float', 'float', 'float', 'bufferPreLenUint8']
    ...
    '0xcc09' : {
        params: ['flags', 'instActivePwr', 'minMeaActivePwr', 'maxMeaActivePwr', 'minRangeActivePwr', 'maxRangeActivePwr', 'cumulActivePwr', 'activePwrCal', 'instReactivePwr', 'minMeaReactivePwr', 'maxMeaReactivePwr', 'minRangeReactivePwr', 'maxRangeReactivePwr', 'resetMinMaxMeaValues', 'cumulReactivePwr', 'reactivePwrCal', 'pwrFactor', 'currCal', 'resetCumulEnergy'],
        types: ['uint32', 'float', 'float', 'float', 'float', 'float', 'float', 'float', 'float', 'float', 'float', 'float', 'float', 'bufferPreLenUint8', 'float', 'float', 'float', 'float', 'bufferPreLenUint8']
    },
    '0xcc0a' : {
        params: ['flags', 'onOff', 'dimmer', 'onTime', 'mStateOut', 'appType'],
        types: ['uint8', 'bool', 'uint8', 'uint16', 'stringPreLenUint8', 'stringPreLenUint8']
    },
    '0xcc0b' : {
        params: ['flags', 'setPointValue', 'colour', 'units', 'appType'],
        types: ['uint8', 'float', 'stringPreLenUint8', 'stringPreLenUint8', 'stringPreLenUint8']
    },
    '0xcc0c' : {
        params: ['flags', 'eventId', 'startTime', 'durationInMin', 'criticalLevel', 'avgLoadAdjPct', 'dutyCycle'],
        types: ['uint8', 'stringPreLenUint8', 'uint32', 'uint16', 'uint8', 'uint8', 'uint8']
    },
    '0xcc0d' : {
        params: ['flags', 'onOff', 'dimmer', 'colour', 'units', 'onTime', 'cumulActivePwr', 'pwrFactor'],
        types: ['uint8', 'bool', 'uint8', 'stringPreLenUint8', 'stringPreLenUint8', 'uint16', 'float', 'float']
    },
    '0xcc0e' : {
        params: ['flags', 'onOff', 'dimmer', 'onTime', 'cumulActivePwr', 'pwrFactor'],
        types: ['uint8', 'bool', 'uint8', 'uint16', 'float', 'float']
    },
    '0xcc0f' : {
        params: ['flags', 'xValue', 'yValue', 'zValue', 'units', 'minRangeValue', 'maxRangeValue'],
        types: ['uint8', 'float', 'float', 'float', 'stringPreLenUint8', 'float', 'float']
    },
    '0xcc10' : {
        params: ['flags', 'xValue', 'yValue', 'zValue', 'units', 'compassDir'],
        types: ['uint8', 'float', 'float', 'float', 'stringPreLenUint8', 'float']
    },
    '0xcc11' : {
        params: ['flags', 'sensorValue', 'units', 'minMeaValue', 'maxMeaValue', 'minRangeValue', 'maxRangeValue', 'resetMinMaxMeaValues'],
        types: ['uint8', 'float', 'stringPreLenUint8', 'float', 'float', 'float', 'float', 'bufferPreLenUint8']
