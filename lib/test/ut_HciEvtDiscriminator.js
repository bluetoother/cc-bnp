var evtBpi = require('../hci/hciEvtDiscriminator');
...
var attReadByGrpTypeRsp   = evtBpi.AttReadByGrpTypeRsp  ();       attReadByGrpTypeRsp  .getHciEvtPacket(12, new Buffer([0x00, 0x01, 0x00, 0x03, 0x05, 0x0C, 0x00, 0x00, 0x00, 0x00]), function(err, result) {console.log('/**********AttReadByGrpTypeRsp**********/'); console.log(err); console.log(result);});
